...
<table>
	<thead>
		<tr>
			<td colspan="2"><h3 class="bx-title"><?=GetMessage("AUTH_REGISTER")?></h3><br></td>
		</tr>
	</thead>
	<tbody>
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><br><input class="btn btn-primary" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>
